...
from django import rest_framework, DjangoFilterBackend
...
class BookListView(generics.ListAPIView):
    ...
    filter_backends = (DjangoFilterBackend, SearchFilter, OrderingFilter)  # Ensure this is correctly specified
